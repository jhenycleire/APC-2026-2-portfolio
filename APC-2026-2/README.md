...
--- 
## Reflexão de Progresso ✨
Como não pude participar das duas primeiras aulas da disciplina, meu foco tem sido entender a lógica estrutural das primeiras linguagens utilizadas. Começamos com a programação visual no OctoStudio para nos apresentarmos, explorando as funcionalidades disponíveis. Além disso, tivemos uma aula sobre o Little Man Computer (LMC). Compreender como funciona a execução da CPU foi inicialmente complicado, mas depois consegui assimilar a lógica de movimentação e armazenamento de dados.